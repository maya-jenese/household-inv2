...
const AddProperty = () => {
	...
	var upload = new Upload({apiKey: "public_12a1xnu4Vp3cu46nRxmH9jMGTdR8"})

	var UploadButton = () => {
		var uploadFile = upload.createFileInputHandler({
			onUploaded: ({fileUrl, fileId}) => {
				propertyData.image = fileId;
			}
		});
	...
	useEffect(() => {
		document.title = "Add Property - West Boca Make-Believe Retirement Community"
	});
									...
									<div className="col-md-8 m-auto">
										...
										<div className={styles.property_list}>
											<form noValidate onSubmit={addPropertyToList}>
												...
												<div id={styles.imageupload} className="form-group">
													<h3>Image Upload</h3>
													<UploadButton/>
												</div>
